...
public class Settings {
	 ...
	 * @parameter
	 */
	private boolean useBiblatex = false;
	 ...
	 * @parameter
	 */
	private String[] tex4htCommandArgs = new String[] { "html,2", "", "",
			"-interaction=nonstopmode --src-specials" };
	...
	public File getOutputDirectory() {
		if (outputDirectoryFile == null) {
			if (StringUtils.isEmpty(outputDirectory)) {
				...
				outputDirectoryFile = new File(targetSiteDirectory,
						outputDirectory);
			}
		}
	...
	public File getTempDirectory() {
		if (tempDirectoryFile == null) {
			String dirName = StringUtils.isBlank(tempDirectory) ? "m2latex"
					: tempDirectory;
	...
	public File getTexDirectory() {
		if (texDirectory == null) {
			texDirectory = new File(new File(new File(baseDirectory, "src"),
					"site"), "tex");
		}
		return texDirectory;
	}
	...
	public Settings setUseBiblatex(boolean useBiblatex) {
		this.useBiblatex = useBiblatex;
		return this;
	}
