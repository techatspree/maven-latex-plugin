...
public class LatexPreProcessor extends AbstractLatexProcessor {
	...
	fig {
	    ...
	    // TEX01, EEX01, WEX02, WEX03, WEX04, WEX05 
		...
		// may log warning EEX01, WEX02, WEX03, WEX04, WEX05 
...
// pz,.eps.Z,.ps.Z,.ps.gz,.eps.gz
     ...
     * <p>
     * Logging: FIXME: 
     * warning EEX01, WEX02, WEX03, WEX04, WEX05 
     *
     * @param figFile
     *    the fig-file to be processed 
     * @param dev
...
// The PDF driver uses all the PostScript options.
	...
	// and  may log warning EEX01, WEX02, WEX03, WEX04, WEX05 
...
//     deleteIfExists(svgFile, SUFFIX_PSTEX );
	...
	// may throw BuildFailureException TEX01, 
	// log warning EEX01, WEX02, WEX03, WEX04, WEX05, WFU03, WPP02 
	...
	Collection<File> latexMainFilesLocal = new TreeSet<File>();
   	for (String fileName : node.getRegularFileNames()) {
		...
		// or tex-files to be inputted. 
    		...
    		// may throw BuildFailureException TEX01, 
    		// log warning EEX01, WEX02, WEX03, WEX04, WEX05 
		// WFU03, WPP02 
		if (!file.isHidden()) {
	...
	latexMainFiles.addAll(latexMainFilesLocal);
	    ...
	    // may throw BuildFailureException TEX01, 
	    // log warning EEX01, WEX02, WEX03, WEX04, WEX05, WPP03 
	    // WFU03, WPP02 
