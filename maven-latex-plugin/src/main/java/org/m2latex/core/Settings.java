...
public class Settings {
    ...
    /**
     * Whether the tex source directory {@link #texSrcDirectory} 
    ...
    @Parameter(name = "readTexSrcDirRec", 
	       defaultValue = "true")
    private boolean readTexSrcDirRec = true;
...
//Process exited with error(s)
   ...
   // parameters for further conversions 
    ...
    public boolean getReadTexSrcDirRec() {
	return   this.readTexSrcDirRec;
    }
...
// FIXME: to be renamed: latex2pdf-command 
   ...
   /**
    ...
    public void setReadTexSrcDirRec(boolean readTexSrcDirRec) {
	this.readTexSrcDirRec = readTexSrcDirRec;
    }
   ...
   // defines e element with text in ant 
	...
	sb.append(", readTexSrcDirRec=")    .append(this.readTexSrcDirRec);
