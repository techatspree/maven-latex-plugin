...
Note that the pattern ends with \texttt{documentclass} or the outdated \texttt{documentstyle}. 
...
As an example document may serve~\ref{PresBeamer} 
which is a presentation of this software and illustrates the use of the beamer class. 
...
In particular, \texttt{.latexmkrc} works for various \LaTeX{} generators. 
...
Note that \texttt{header.tex} is intended for use of 
%
\begin{itemize}
...
In the long run \texttt{header.tex} could be adapted to the configuration as \texttt{.latexmkrc}, 
