...
except Auc\TeX{}, because this places magic comments at the end of file, 
...
As a magic comment can be used to specify the target formats for a latex main file individually, 
Section~\ref{subsec:sourcesLatex} shows how to specify the latex converter to be used for this file 
