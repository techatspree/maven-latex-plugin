...
CAUTION\@: The latex processor is \xelatex{} 
...
% TBD: this is almost duplicate of lst:versionsExec
...
An alternative is vscode in conjunction with the extension \texttt{latex workshop}. 

A valuable standalone tool is \texttt{latexmk}. 
