...
%
\begin{Verbatim}
  mvn latex:inj -Dlatex.injections=latexmkrc,chktexrc,vscodeExt
\end{Verbatim}
%
...
\subsection{A header file to support graphics }\label{subsec:headerGrp}
...
The last injection, \texttt{vscodeExt} 
injecting the file \href{\urlSite fromMain/instVScode4tex}{instVScode4tex.sh} 
