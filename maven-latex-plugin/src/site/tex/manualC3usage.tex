...
So far, \texttt{scrlttr2} is the only KOMA\index{KOMA} class this software has been tested for. 
...
Nevertheless, the pattern \texttt{patternLatexMainFile} matches all possible document classes. 
