...
dvi%
\fi.
The package \texttt{tex4ht} is \aaa loaded. 
...
\end{tabular}
%
The \texttt{Headline} ist the sole line defining an ellipse. 
...
which separates the coordinate field \texttt{x, y} from the \texttt{Text} field. 
