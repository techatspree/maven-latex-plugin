...
\begin{minipage}{0.95\linewidth}
   ...
   which fit well. 
   Note also that miktex does not offer neither package \pkg{bmpsize} 
   nor \texttt{ebb}. 
...
\begin{description}
  ...
  The value 2 is a compromize between safe quality of output and length of artifact. 
  ...
  Unlike the default value of \texttt{mpost}, no number of the figure within the metapost file is given. 
...
he default value is '\texttt{-V1.7}' specifying the pdf version to be created. 
