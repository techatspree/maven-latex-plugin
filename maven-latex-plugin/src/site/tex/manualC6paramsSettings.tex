...
given by 'docClassesToTargets'. 
Currently, only the class 'beamer' has restrictions. 
...
linerange={157-162}, % chktex 8 TBD: why is this nost covered by .chktexrc? 
breaklines,
%float,
...
The \cmd{documentclass} or \cmd{documentstyle} 
