...
\begin{itemize}
  \item
  `\texttt{article,report,book:chk,dvi,pdf,html,odt,docx,rtf,txt}' 
  ensures that article and book allow all targets. 
  \item
  `\texttt{beamer,leaflet,scrlttr2:chk,pdf,txt}' beamer allows mainly \texttt{pdf} and derived from that \texttt{txt}.  
