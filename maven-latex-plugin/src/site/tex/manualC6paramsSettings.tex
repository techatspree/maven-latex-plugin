...
\begin{description}
\item[latexmkrc] represents the file \texttt{.latexmkrc} 
\item[chktexrc] represents the file \texttt{.chktexrc} 
\item[vscodeExt] represents the file \texttt{instVScode4tex.sh} 
\item[header] represents the file \texttt{header.tex}
\end{description}
\end{minipage}
}\\ % chktex 9 chktex 10 (bug) 
\end{longtable}
