...
linerange={166-176}, % chktex 8 TBD: why is this not covered by .chktexrc? 
breaklines,
%float,
...
%
\begin{description}
  \item[1] The \texttt{\textbackslash A} indicates the start of the file. 
  ...
  \item[6--10] Except for magic comments, 
