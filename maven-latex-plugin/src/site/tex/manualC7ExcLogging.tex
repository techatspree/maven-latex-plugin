...
\texttt{\footnotesize WLP09} 
& \texttt{\footnotesize Found file '\$texFile' with unknown document class '\$docClass'. } \\
\multicolumn2{|l|}{
\begin{minipage}{0.95\linewidth}
...
\texttt{\footnotesize WSS01} 
& \texttt{\footnotesize Syntax error in chunk '\$chunk'; maybe ignoring targets. } \\
\multicolumn2{|l|}{
\begin{minipage}{0.95\linewidth}
...
& \texttt{\footnotesize For document class '\$cls' specifying target set again; merging.  } \\
\multicolumn2{|l|}{
\begin{minipage}{0.95\linewidth}
