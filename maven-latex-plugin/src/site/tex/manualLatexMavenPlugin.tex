...
by the command \texttt{\textbackslash input\{xxx.ptx\}} 
...
as \texttt{\textbackslash includegraphics\{pppxxx\}}. 
...
and embedded in this \LaTeX-file with the \texttt{\textbackslash input}-command. 
...
This is done as usual with \texttt{\textbackslash includegraphics}. 
...
The special (\texttt{\textbackslash special}) instructions seeded in the dvi-code 
