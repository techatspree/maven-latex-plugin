...
\hline
\hline
\tt\footnotesize TFU01 & \tt\footnotesize Destination directory '\$targetDir' 
...
\tt\footnotesize TFU03 & \tt\footnotesize Destination directory '\$targetDir'
		     cannot be created.   \\
\multicolumn2{|l|}{
\begin{minipage}{0.95\linewidth}
...
\tt\footnotesize TFU04 & \tt\footnotesize Destination file '\$destFile' 
...
\tt\footnotesize TFU05  & \tt\footnotesize Destination file '\$destFile'
...
\tt\footnotesize TFU06 & \tt\footnotesize Error copying file '\$srcFileName'
...
\hline
\hline
\tt\footnotesize WEX01  & \tt\footnotesize Running \$command 
...
\tt\footnotesize WAP02 & \tt\footnotesize Running \$command failed: 
...
\tt\footnotesize WAP01  & \tt\footnotesize Running \$command failed. 
...
\hline
\caption{\label{tab:WarnALP} The Warnings on running a command  }
\end{longtable}
...
\tt\footnotesize WFU05  & \tt\footnotesize Cannot delete file '\$delFile'.  \\
\multicolumn2{|l|}{
\begin{minipage}{0.95\linewidth}
...
\hline
\caption{\label{tab:WarnCEI} The Warnings on files/streams  }
\end{longtable}
...
\tt\footnotesize WLP01  & \tt\footnotesize LaTeX requires rerun but maximum number 
...
\hline
\caption{\label{tab:WarnLPP} Miscellaneous Warnings  }
\end{longtable}
