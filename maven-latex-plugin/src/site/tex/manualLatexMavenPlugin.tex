...
To include svg-files into latex \index{svg}, 
...
\end{center}
\caption{\label{fig:asIsJpg}
Some jpg-picture, directly included }
\end{figure}


Figure \ref{fig:asIsSvg} is a picture in svg-format and included directly. 
...
\begin{figure}[htb]
\begin{center}
\input{07some.pdf_tex}
%\includesvg[width=0.9\textwidth]{07some}%
\end{center}
\caption{\label{fig:asIsSvg}
Some svg-picture, directly included }
\end{figure}
