...
\newacronym{ist}{ist}{(make-)index style file: output format of tex processors 
...
\texttt{\footnotesize TSS08}  & \texttt{\footnotesize Tried to use converter '\$convStr' } \\
 ...
 \begin{minipage}{0.95\linewidth}
   ...
   So e.g. \texttt{lualatex} is only allowed in configuration
...
Running with the plugin, e.g.~with \texttt{pdflatex}, we obtain 
%
