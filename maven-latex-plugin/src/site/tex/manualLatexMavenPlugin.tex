...
(/usr/local/texlive/2014/texmf-dist/tex/generic/tex4ht/html4.4ht
--------------------------------------
--- Note --- For section filenames that reflect on their titles use the command
 line option `sec-filename'
--------------------------------------
--------------------------------------
...
--------------------------------------
--------------------------------------
--- Note --- to eliminate mini tables of contents, use the command line option 
`nominitoc'
--------------------------------------
--------------------------------------
--- Note --- for frames-like object-based table of contents, use the command li
ne option `obj-toc'
--------------------------------------
--------------------------------------
...
\subsection{Creating MS word files}\label{subsec:tex2doc}
...
\tt patternClearFromLatexMain & see Section~\ref{subsubsec:patternClearFromLatexMain} \\
\multicolumn2{|l|}{
\begin{minipage}{0.95\linewidth}
For goal `{\tt clr}', 
...
\subsubsection{The parameter {\tt patternClearFromLatexMain}}
\label{subsubsec:patternClearFromLatexMain}
...
\tt metapostOptions & see Section~\ref{subsubsec:patternClearFromLatexMain} \\
\multicolumn2{|l|}{
\begin{minipage}{0.95\linewidth}
...
\tt\footnotesize WEX02 & \tt\footnotesize Running \$command failed: 
...
\tt\footnotesize WEX03 & \tt\footnotesize Running \$command failed: 
