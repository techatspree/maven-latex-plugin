...
FIXME: What if a table of contents 
and either bibliography, index or glossary is present? 
Required is a third latex run. 
...
For text output: rerun is insufficient to make pagenumbers right. 
