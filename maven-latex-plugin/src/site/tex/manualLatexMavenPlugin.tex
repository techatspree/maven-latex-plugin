...
- '\textasciicircum T\$T(se|su)\textbackslash d+\textbackslash.x?html?\$' 
...
can be summarized as '\textasciicircum T\$T((se|su|li)?\d+)?\.x?html?\$'. 
Adding the patterns for the css-file and the svg-files, 
we obtain 
'\textasciicircum T\$T(((se|su|li)?\textbackslash
