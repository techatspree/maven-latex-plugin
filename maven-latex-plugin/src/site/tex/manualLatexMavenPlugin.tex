...
Section~\ref{subsec:tex2html} describes creation of 
\gls{html}, Section~\ref{subsec:tex2odt} the creation of \gls{odt} and 
Section~\ref{subsec:tex2doc} creation of MS word formats like \gls{docx}. 
Finally, also pure text can be generated 
as described in Section~\ref{subsec:tex2txt}. 
