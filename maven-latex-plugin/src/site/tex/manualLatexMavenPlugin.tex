...
This software supports sorting 
...
Using {\tt xindy} can be activated through 
...
What the command {\tt\textbackslash makeglossaries} 
(which is invoked without file ending) does is, 
it determines from the aux-file 
  ...
  <target name="pdf"
    ...
    <latex>
      ...
      <settings texSrcDirectory="src/site/tex"
		...
		texCommand="pdflatex"
		texCommandArgs="-interaction=nonstopmode -synctex=1 -src-specials -recorder -shell-escape"
		debugBadBoxes='true'
		debugWarnings='true'
