...
Comparable with the xfig-format described in Section~\ref{subsec:fig2dev} 
...
As described for fig-files in Section~\ref{subsec:fig2dev} 
and for gnuplot-files in Section~\ref{subsec:gnuplot2pdf}: 
...
pdftops or something? 

FIXME: picture illustrating the conversion is missing 
