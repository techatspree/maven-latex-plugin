...
Another solution is 
to use pacakges {\tt robustindex} and {\tt robustglossaries}. 
...
There is a problem in conjunction with emacs: 
creates swap file {\tt .xxx.tex}. 
This must be excluded from latex main files. 
This may be done by ignoring files starting with {\tt.}. 
