...
\end{verbatim}
The java\index{java} version is {\tt 1.8.0\_101, vendor: Oracle Corporation}. 
...
typically not inputted anywhere, are called {\em \LaTeX{} main files}. 
As an example, 
...
\lstinputlisting[firstline=214, lastline=748]{../../../pom.xml}
