...
\pdfvariable minorversion=7 % for lualatex
...
\pdfvariable suppressoptionalinfo 767 % for lualatex
% no adding to the trailer dictionary.
%\pdftrailer=0                        % for pdflatex
%\pdftrailerid{}                      % for pdflatex
\pdfvariable trailerid{}              % for lualatex

%\pdfsuppressptexinfo=-1               % for pdflatex
\pdfvariable suppressoptionalinfo -1  % for lualatex
