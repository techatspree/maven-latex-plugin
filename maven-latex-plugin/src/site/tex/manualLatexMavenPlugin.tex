...
% epub for example, html and office formats 
...
containing all graphics but text and a file \texttt{xxx.pdf\_tex}
...
there was a configuration which made \texttt{xxx.eps\_tex}
able to include uniformly both \texttt{xxx.pdf} and \texttt{xxx.eps}.
