...
Section~\ref{subsec:logWarnErr} describes the errors and warnings; 
...
\subsection{Logging of Warnings and Errors}\label{subsec:logWarnErr}
...
but at least one warning, this software logs a warning. 
\end{itemize}
