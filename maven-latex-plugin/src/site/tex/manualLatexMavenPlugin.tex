...
To satisfy this task, one may apply a latex to pdf converter 
to a master tex-file {\tt xxx.tex}. 
The latex to pdf converter is configurable via the parameter {\tt texCommand} 
...
In fact, the converter does much more than converting tex to pdf. 
Figure \ref{fig:tex2pdf} shows, 
that besides the pdf-file also a log-file and an aux-file is created. 
In addition, 
if a table of contents, a list of figures or a list of tables is to be
created, 
also a toc-file, a lof-file and a lot-file is created. 
If an index is created, in addition an idx-file is created. 
...
Essentially, {\ttbibtex} extracts the citations in the aux-file 
