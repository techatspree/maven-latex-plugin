...
This maven plugin offers a goal \texttt{dvl} (``development'') 
to create the configuration files \texttt{.latexmkrc} and \texttt{.chktexrc} 
both in the latex source directory. 
In particular \texttt{.latexmkrc} is adapted to the current settings of this plugin. 
That way, \texttt{latexmk} behave the same as does this plugin. 
...
As for goal \texttt{dvl}, in case of a doubt, a warning is displayed. 
