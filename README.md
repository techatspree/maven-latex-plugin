...
Use the maven-latex-plugin in your Maven projects 
and the ant tasks in your ant projects 
to automatically convert 
all LaTeX documents `*.tex` into desired output format. 
...
Download under 
https://www.simuline.eu/LatexMavenPlugin/manualLatexMavenPlugin.pdf.
...
The homepage can be found in https://www.simuline.eu/LatexMavenPlugin/, 
whereas the project is hosted on GitHub: 
https://github.com/Reissner/maven-latex-plugin 
forked from https://github.com/akquinet/maven-latex-plugin
...
### Output in various formats <a name='sss:featuresOutFormats'>
...
### Cleanup after creation <a name='sss:featuresCleanup'>
...
### Check of sources and results, logging <a name='sss:featuresCheckLog'>
...
### Input of various graphics formats <a name='sss:featuresInputGrp'>
...
## Installation <a name='ss:installation'>
